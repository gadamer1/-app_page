...
const configureStore = (initialState, options) => {
  ...
  const store = Object(redux__WEBPACK_IMPORTED_MODULE_9__["createStore"])(_reducers__WEBPACK_IMPORTED_MODULE_7__["default"], initialState, enhancer);
  store.sagaTask = sagaMiddleware.run(_sagas__WEBPACK_IMPORTED_MODULE_6__["default"]);
  return store;
};

/* harmony default export */ __webpack_exports__["default"] = (next_redux_wrapper__WEBPACK_IMPORTED_MODULE_3___default()(configureStore)(next_redux_saga__WEBPACK_IMPORTED_MODULE_4___default()(MapApp)));
...
/* harmony import */ var _label__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./label */ "./sagas/label.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! axios */ "axios");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_2__);



axios__WEBPACK_IMPORTED_MODULE_2___default.a.defaults.baseURL = 'http://localhost:8080/api';
function* rootSaga() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["all"])([Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["fork"])(_label__WEBPACK_IMPORTED_MODULE_1__["default"])]);
}
...
function loadLabelListAPI() {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.get('/label/list');
}

function* loadLabelList() {
  try {
    const result = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(loadLabelListAPI);
    yield console.log(result);
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])({
      type: _reducers_label__WEBPACK_IMPORTED_MODULE_2__["LOAD_LABELLIST_SUCCESS"],
      data: result.data
    });
  } catch (e) {
    console.error(e);
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])({
      type: _reducers_label__WEBPACK_IMPORTED_MODULE_2__["LOAD_LABELLIST_FAILURE"],
      error: e
    });
  }
}
...
function* watchLoadLabelList() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeLatest"])(_reducers_label__WEBPACK_IMPORTED_MODULE_2__["LOAD_LABELLIST_REQUEST"], loadLabelList);
}

function postLabelListAPI(label) {
  return axios__WEBPACK_IMPORTED_MODULE_1___default.a.post('/label/list', {
    label
  });
}
...
function* postLabelList(action) {
  try {
    const result = yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["call"])(postLabelListAPI, action.data);
    yield console.log(result);
    yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["put"])({
      type: _reducers_label__WEBPACK_IMPORTED_MODULE_2__["POST_LABELLIST_SUCCESS"],
      data: result.data
    });
  } catch (e) {
    console.error(e);
...
function* watchPostLabelList() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["takeLatest"])(_reducers_label__WEBPACK_IMPORTED_MODULE_2__["POST_LABELLIST_REQUEST"], postLabelList);
}

function* labelSaga() {
  yield Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["all"])([Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["fork"])(watchLoadLabelList), Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_0__["fork"])(watchPostLabelList)]);
}
